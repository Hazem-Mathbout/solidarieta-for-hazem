...
import 'package:solidarieta/src/core/components/qibla_files/location_error_widget.dart';
            ...
            builder: (_, AsyncSnapshot<LatLng> snapshot) => GoogleMap(
              ...
              circles: Set<Circle>.of([
                Circle(
                  ...
                  radius: 10,
                  center: position,
                  fillColor: Color(0xff00a8cc).withAlpha(100),
                  strokeWidth: 1,
                  strokeColor: Color(0xff27496d).withAlpha(100),
                  zIndex: 3,
                )
              ]),
